...
-- Repeats walking attempts.
-- Until, exceeds walk_attempts value.
-- Or not on map or on map with a different id. Which indicates entering a new map. Like entering a building.
-- Or reached hm tile that requires player interaction. Example a bush or water tile that needs entering. 
-- Or finished walking by reaching or facing destination. Example standing on a building exit or facing an NPC.
